function varargout = Undirected_VisualsGui_2(varargin)
% UNDIRECTED_VISUALSGUI_2 MATLAB code for Undirected_VisualsGui_2.fig
%      UNDIRECTED_VISUALSGUI_2, by itself, creates a new UNDIRECTED_VISUALSGUI_2 or raises the existing
%      singleton*.
%
%      H = UNDIRECTED_VISUALSGUI_2 returns the handle to a new UNDIRECTED_VISUALSGUI_2 or the handle to
%      the existing singleton*.
%
%      UNDIRECTED_VISUALSGUI_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UNDIRECTED_VISUALSGUI_2.M with the given input arguments.
%
%      UNDIRECTED_VISUALSGUI_2('Property','Value',...) creates a new UNDIRECTED_VISUALSGUI_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Undirected_VisualsGui_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Undirected_VisualsGui_2_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Undirected_VisualsGui_2_OpeningFcn, ...
                   'gui_OutputFcn',  @Undirected_VisualsGui_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Undirected_VisualsGui_2 is made visible.
function Undirected_VisualsGui_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Undirected_VisualsGui_2 (see VARARGIN)

% Choose default command line output for Undirected_VisualsGui_2
...
% UIWAIT makes Undirected_VisualsGui_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Undirected_VisualsGui_2_OutputFcn(hObject, eventdata, handles) 
...
P.Undirected_Tag=true;
P.Directed_Tag =false;
P.Save_Tag= false;
