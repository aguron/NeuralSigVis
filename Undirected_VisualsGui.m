function varargout = Undirected_VisualsGui(varargin)
% UNDIRECTED_VISUALSGUI MATLAB code for Undirected_VisualsGui.fig
%      UNDIRECTED_VISUALSGUI, by itself, creates a new UNDIRECTED_VISUALSGUI or raises the existing
%      singleton*.
%
%      H = UNDIRECTED_VISUALSGUI returns the handle to a new UNDIRECTED_VISUALSGUI or the handle to
%      the existing singleton*.
%
%      UNDIRECTED_VISUALSGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UNDIRECTED_VISUALSGUI.M with the given input arguments.
%
%      UNDIRECTED_VISUALSGUI('Property','Value',...) creates a new UNDIRECTED_VISUALSGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Undirected_VisualsGui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Undirected_VisualsGui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Undirected_VisualsGui

% Last Modified by GUIDE v2.5 30-Nov-2015 12:18:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Undirected_VisualsGui_OpeningFcn, ...
                   'gui_OutputFcn',  @Undirected_VisualsGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Undirected_VisualsGui is made visible.
function Undirected_VisualsGui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Undirected_VisualsGui (see VARARGIN)

% Choose default command line output for Undirected_VisualsGui
...
% UIWAIT makes Undirected_VisualsGui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Undirected_VisualsGui_OutputFcn(hObject, eventdata, handles) 
